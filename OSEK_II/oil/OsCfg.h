...
*******************************************************************************/
extern void OsTask_AppTask_PeriodicExtended(void); 
extern void OsTask_AppTask_PeriodicBasic(void); 
...
enum OsCfg_TaskIDs
{
	AppTask_PeriodicExtended,
	AppTask_PeriodicBasic
};
/*******************************************************************************
	Symbolic names for wait events for each thread
*******************************************************************************/
/*AppTask_PeriodicExtendedEvents*/
#define Periodic50Tick		1
/*AppTask_PeriodicBasicEvents*/
