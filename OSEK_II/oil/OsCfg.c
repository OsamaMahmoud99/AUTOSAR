/*******************************************************************************
	Module Name:		OsCfg.c
	Generation Date:	2023-September-Sunday	07:13:39
	Tool Version: 		V.0
...
{
	{/*SP*/0u, /*basic SP*/0u , /*task pointer*/OsTask_AppTask_PeriodicExtended, 
	...
	{/*SP*/0u, /*basic SP*/0u , /*task pointer*/OsTask_AppTask_PeriodicBasic, 
...
{
	50,		/*AppTask_PeriodicExtended*/
	50		/*AppTask_PeriodicBasic*/
};
...
acb_t OsCfg_Alarms[1/*OsCfg_MAX_NUM_OF_ALARMS*/] =
{
	...
	/*base type*/&MainCounter, /*task id*/AppTask_PeriodicBasic, /*event id*/INVALID_ID,
