 ...
 *
 * Generated from application timer
...
DeclareTask(RteTaskCyclicTask);
DeclareTask(RteTaskOIE);
DeclareAlarm(OSAlarm10ms);
DeclareEvent(OSEvent_10ms);
DeclareEvent(OSOIEvent);
