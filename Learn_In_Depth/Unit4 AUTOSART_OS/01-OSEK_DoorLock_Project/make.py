...
# -*- coding: UTF-8 -*-
#----------------------------------------------------------------------
#--- Python Make file for application timer
...
try:
	...
	print("\033[91mThe OS->BUILD->TRAMPOLINE_BASE_PATH key is not set correctly in the oil file LearnInDepth_SW.oil.")
	print("Set the correct Trampoline installation path in the oil file and run goil again:\033[0m")
	print("goil -t=cortex-m/armv7em/stm32f407/stm32f4discovery --templates=../../../goil/templates/ LearnInDepth_SW.oil")
	sys.exit(1)
...
#----------------------------------------------------------------------
oilFile = "LearnInDepth_SW.oil"
oilFileDep = "build/" + oilFile + ".dep"
oilCompiler = "goil"
oilFlags = ["-t=cortex-m/armv7em/stm32f407/stm32f4discovery", "--templates=../../../goil/templates/"]
...
#--- Add generated files
sourceList.append("LearnInDepth_SW/tpl_app_config.c")

sourceList.append("LearnInDepth_SW/tpl_dispatch_table.c")
sourceList.append("LearnInDepth_SW/tpl_invoque.S")
sourceList.append("LearnInDepth_SW/tpl_primary_irq.S")
sourceList.append("LearnInDepth_SW/tpl_vectors.c")
sourceList.append("LearnInDepth_SW/tpl_external_interrupts.c")
sourceList.append("LearnInDepth_SW/tpl_app_interrupts.c")
