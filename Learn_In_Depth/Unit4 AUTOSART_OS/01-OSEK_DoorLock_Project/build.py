...
cSourceList.append(projfile.ProjectFile("./AUTOSAR_implementation/DoorLock_indication_SWC.c"))
cSourceList.append(projfile.ProjectFile("./AUTOSAR_implementation/DoorSensorAbstactionSWC.c"))
cSourceList.append(projfile.ProjectFile("./AUTOSAR_implementation/RTE_gen/Rte_DoorLock_indication_SWC.c"))
cSourceList.append(projfile.ProjectFile("./AUTOSAR_implementation/RTE_gen/Rte_DoorSensorAbstactionSWC.c"))
