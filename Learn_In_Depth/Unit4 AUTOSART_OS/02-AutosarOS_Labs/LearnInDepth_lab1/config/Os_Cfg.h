...
// Application Id's
#define APPLICATION_ID_Application1  0
...
// Task Id's
#define TASK_ID_OsIdleTask	0
#define TASK_ID_OsBTask 	1
#define TASK_ID_OsExTask1	2
...
#define LearnIndepth_exTask_STACK_SIZE 2048
