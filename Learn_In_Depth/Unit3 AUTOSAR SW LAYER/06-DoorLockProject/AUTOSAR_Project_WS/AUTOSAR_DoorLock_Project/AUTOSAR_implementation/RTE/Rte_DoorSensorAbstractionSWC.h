 ...
 *****************************************************/
extern void Rte_IWrite_DoorSensorAbstractionSWC_ReadDoorSensor_PP_SRI_DoorState (myuint8 DoorState);
#ifndef IN_RTE_C
#define Rte_IWrite_ReadDoorSensor_PP_SRI_DoorState(RTEData) \
	Rte_IWrite_DoorSensorAbstractionSWC_ReadDoorSensor_PP_SRI_DoorState(RTEData)
#endif
extern myuint8* Rte_IWriteRef_DoorSensorAbstractionSWC_ReadDoorSensor_PP_SRI_DoorState(void);
#ifndef IN_RTE_C
#define Rte_IWriteRef_ReadDoorSensor_PP_SRI_DoorState() \
	Rte_IWriteRef_DoorSensorAbstractionSWC_ReadDoorSensor_PP_SRI_DoorState()
#endif
