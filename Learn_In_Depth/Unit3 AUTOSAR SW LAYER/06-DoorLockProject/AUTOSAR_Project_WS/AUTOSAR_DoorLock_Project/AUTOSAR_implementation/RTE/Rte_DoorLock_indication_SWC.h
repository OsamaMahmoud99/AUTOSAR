 ...
 *****************************************************/
extern Std_ReturnType Rte_Call_DoorLock_indication_SWC_RP_CS_LedSwitch_Led_switch (myuint8 LedState);
#ifndef IN_RTE_C
#define Rte_Call_RP_CS_LedSwitch_Led_switch(LedState) \
	Rte_Call_DoorLock_indication_SWC_RP_CS_LedSwitch_Led_switch(LedState)
#endif
...
typedef Std_ReturnType (*FunctionPtr_DoorLock_indication_SWC_RP_CS_LedSwitch_Led_switch)(myuint8 LedState);
